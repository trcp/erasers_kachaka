...
def generate_launch_description():
    ...
    prefix_erk_common = get_package_share_directory("erasers_kachaka_common")
    ...
    declare_container_point =  DeclareLaunchArgument(
            'target_frame',
            default_value='container_kachaka/base_link',
            description='TF frame to publish point and marker in'
        )
    ...
    ld.add_action(declare_container_point)
    ...
    node_container =  Node(
            package = "erasers_kachaka_common",
            executable='publish_container_point',
